            ...
            <IonRow>
                  ...
                  <IonItem>
                    ...
                    {[...Array(5)].map((_, i) => (
                      <IonIcon
                        ...
                        icon={star}
                        style={{
                          color: i < userRating.averageRating ? "gold" : "gray",
                        }}
                      />
                    ))}
                  </IonItem>
              ...
              <IonCol size="12" size-md="8">
                  ...
                  <IonCardContent>
                    <IonList lines="none" className="recent-activity">
                      {pinnedBlogs.map((blog) => (
                        <IonItem
                          key={blog.blog_id}
                          className="recent-activity-content"
                        >
                          <IonLabel className="no-hover-label">
                ...
                <IonCard>
                  <IonCardHeader>
                    <IonCardTitle>
                      Actividad de Asociaciones Reciente
                    </IonCardTitle>
                  </IonCardHeader>
                  <IonCardContent>
                    <IonList lines="none">
